...
pushd bison
  ...
  make HELP2MAN="touch doc/bison.1.tmp doc/bison.x doc/bison.1 && true" MANDEPS="" ${JOBS:+-j $JOBS}
  make HELP2MAN="touch doc/bison.1.tmp doc/bison.x doc/bison.1 && true" MANDEPS="" install
popd
pushd flex
  autoreconf -ivf
  ./configure --prefix ${INSTALLROOT} --disable-manpages
