...
G4ABLADATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4ABLA*'`;[[ -z $G4ABLADATA ]] && G4ABLADATA=not-defined  ## v10.4.px only
G4ENSDFSTATEDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4ENSDFSTATE*'`;[[ -z $G4ENSDFSTATEDATA ]] && G4ENSDFSTATEDATA=not-defined  ## v10.5.px only
G4INCLDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4INCL*'`;[[ -z $G4INCLDATA ]] && G4INCLDATA=not-defined
G4LEDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4EMLOW*'`;[[ -z $G4LEDATA ]] && G4LEDATA=not-defined
G4LEVELGAMMADATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*PhotonEvaporation*'`;[[ -z $G4LEVELGAMMADATA ]] && G4LEVELGAMMADATA=not-defined
G4NEUTRONHPDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4NDL*'`;[[ -z $G4NEUTRONHPDATA ]] && G4NEUTRONHPDATA=not-defined
G4NEUTRONXSDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4NEUTRONXS*'`;[[ -z $G4NEUTRONXSDATA ]] && G4NEUTRONXSDATA=not-defined   ## v10.4.px only
G4PARTICLEXSDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4PARTICLEXS*'`;[[ -z $G4PARTICLEXSDATA ]] && G4PARTICLEXSDATA=not-defined  ## v10.5.px only
G4PIIDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*G4PII*'`;[[ -z $G4PIIDATA ]] && G4PIIDATA=not-defined
G4RADIOACTIVEDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*RadioactiveDecay*'`;[[ -z $G4RADIOACTIVEDATA ]] && G4RADIOACTIVEDATA=not-defined
G4REALSURFACEDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT '*data*RealSurface*'`;[[ -z $G4REALSURFACEDATA ]] && G4REALSURFACEDATA=not-defined
G4SAIDXSDATA=`find ${INSTALLROOT} $G4DATASEARCHOPT  '*data*G4SAIDDATA*'`;[[ -z $G4SAIDXSDATA ]] && G4SAIDXSDATA=not-defined
