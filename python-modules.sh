...
PIP39_REQUIREMENTS=${PIP39_REQUIREMENTS_$(ARCHITECTURE | tr - _):-$PIP39_REQUIREMENTS}
PIP310_REQUIREMENTS=${PIP310_REQUIREMENTS_$(ARCHITECTURE | tr - _):-$PIP310_REQUIREMENTS}
