...
prefer_system: (?!slc5)
prefer_system_check: |
  ${ALIBUILD_SYSTEM_VIEW:+$ALIBUILD_SYSTEM_VIEW/bin/}python -c 'import matplotlib,numpy,certifi,IPython,ipywidgets,ipykernel,notebook.notebookapp,metakernel,yaml';
