...
$([[ ${ARCHITECTURE:0:3} == osx ]] && echo "prepend-path DYLD_LIBRARY_PATH \$GCC_TOOLCHAIN_ROOT/lib")
prepend-path LD_LIBRARY_PATH \$GCC_TOOLCHAIN_ROOT/lib64
$([[ ${ARCHITECTURE:0:3} == osx ]] && echo "prepend-path DYLD_LIBRARY_PATH \$GCC_TOOLCHAIN_ROOT/lib64")
