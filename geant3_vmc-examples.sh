...
# Dependencies
module load BASE/1.0 ${ROOT_REVISION:+ROOT/$ROOT_VERSION-$ROOT_REVISION} GEANT4_VMC/$GEANT4_VMC_VERSION-$GEANT4_VMC_REVISION GEANT3/$GEANT3_VERSION-$GEANT3_REVISION PYTHIA6/$PYTHIA6_VERSION-$PYTHIA6_REVISION
EoF
