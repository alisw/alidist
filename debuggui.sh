...
tag: 82f19c0fc0c82db1819bac66f1880f3e5d474cca
requires:
  - "GCC-Toolchain:(?!osx)"
  - GLFW
build_requires:
...
# Dependencies
module load BASE/1.0  ${GCC_TOOLCHAIN_REVISION:+GCC-Toolchain/$GCC_TOOLCHAIN_VERSION-$GCC_TOOLCHAIN_REVISION} ${GLFW_REVISION:+GLFW/$GLFW_VERSION-$GLFW_REVISION}
