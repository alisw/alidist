...
FST_SYNC_EXTRA_WORKFLOW_PARAMETERS=QC QC_REDIRECT_MERGER_TO_LOCALHOST=1 GEN_TOPO_WORKDIR=`pwd` WORKFLOW_DETECTORS_QC=ITS,TOF,TRD,MFT,MCH,MID,HMP,EMC,PHS,EMC,FT0,FV0,FDD,ZDC ALICE_O2SIM_DUMPLOG=1 NEvents=5 NEventsQED=100 O2SIMSEED=12345 $O2_ROOT/prodtests/full_system_test.sh
