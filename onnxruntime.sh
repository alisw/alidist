...
cmake "$SOURCEDIR/cmake"                                                                               \
      ...
      -DFETCHCONTENT_SOURCE_DIR_ABSEIL_CPP=${ABSEIL_ROOT}/src                                          \
      ${PROTOBUF_REVISION:+-DProtobuf_LIBRARY=$PROTOBUF_ROOT/lib/libprotobuf.a}                        \
      ${PROTOBUF_REVISION:+-DProtobuf_LITE_LIBRARY=$PROTOBUF_ROOT/lib/libprotobuf-lite.a}              \
      ${PROTOBUF_REVISION:+-DProtobuf_PROTOC_LIBRARY=$PROTOBUF_ROOT/lib/libprotoc.a}                   \
      ${PROTOBUF_REVISION:+-DProtobuf_INCLUDE_DIR=$PROTOBUF_ROOT/include}                              \
      ${PROTOBUF_REVISION:+-DProtobuf_PROTOC_EXECUTABLE=$PROTOBUF_ROOT/bin/protoc}                     \
      ${PROTOBUF_REVISION:+-DONNX_CUSTOM_PROTOC_EXECUTABLE=$PROTOBUF_ROOT/bin/protoc}                  \
