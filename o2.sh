...
cmake $SOURCEDIR -DCMAKE_INSTALL_PREFIX=$INSTALLROOT                                              \
      ...
      -DO2_TPCCA_TRACKING_LIB_DIR=$HLTO2CATRACKING_ROOT
...
# Dependencies
module load BASE/1.0 FairRoot/$FAIRROOT_VERSION-$FAIRROOT_REVISION ${DDS_VERSION:+DDS/$DDS_VERSION-$DDS_REVISION} ${GCC_TOOLCHAIN_VERSION:+GCC-Toolchain/$GCC_TOOLCHAIN_VERSION-$GCC_TOOLCHAIN_REVISION} ${VC_VERSION:+Vc/$VC_VERSION-$VC_REVISION} $DEPENDENCY_HLTO2TPCCA $HLTO2CATRACKING_VERSION-$HLTO2CATRACKING_REVISION
# Our environment
